...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("Website", "Sitio web"),
        ("About", "Acerca de"),
        ("Slogan_tip", "La respuesta a nuestra necesidad de conectar."),
        ...
        ("install_tip", "Para acceso remoto permanente, instala NeoDesk en tu equipo. Se ejecutará automáticamente en cada reinicio."),
